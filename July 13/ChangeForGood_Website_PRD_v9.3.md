...
| 8.5 | July 29, 2026 | Article 1 cover image added to Resources card thumbnail and article page header; image cropping adjusted — Resources card anchored to top to show title text; article page removes maxHeight constraint to show full image including people in the lower portion |
| 8.6 | July 29, 2026 | Resources page: Articles 2 and 3 placeholder cards updated — CFG logo (white, 130px) on dark purple gradient background replaces generic placeholder text |
| 8.7 | August 4, 2026 | Article 1: Four Player Model roles expanded with detailed descriptions; "Follower" renamed to "Supporter" throughout; David Kantor credited as originator of the Four Player Model (Reading the Room, Jossey-Bass, 2012) |
| 8.8 | August 22, 2026 | Services page: Four Intervention Programmes section added below the services carousel — Tech For Good, Build For Good, Lead For Good, and Innovate For Good — each with a themed accent colour, icon, category label, and description in a responsive 2×2 grid |
| 8.9 | August 22, 2026 | About page: Co-Founder Jimbo Reverente section added — full bio with profile photo (Jimbo 2), quote banner with Jimbo 1 full-bleed photo background and gradient overlay, and two-sided credentials timeline from CV. "Book a discovery call with Chenny" button added after Chenny's credentials; "Book a discovery call with Jimbo" button added after Jimbo's credentials — both link to the Contact page. |
| 9.0 | September 10, 2026 | Resources page: Innovation Readiness Diagnostic added alongside the Clarity-First Diagnostic. Assesses organisational innovation readiness across 5 dimensions — Innovation Leadership, People & Mindset, Culture & Environment, Feasibility & Capacity, and Market-Centredness — with 10 questions, a pentagon radar chart, area-by-area results, 4 result profiles, and a CTA to book a discovery call with Jimbo. Resources page updated to show both diagnostics as separate cards under a "Free Diagnostics" section. |
| 9.1 | September 10, 2026 | Contact page: office address added to "Reach us directly" section — Unit No. 5401, Corporate Finance Plaza, Ruby & Topaz Road, Ortigas Center, Pasig City, Philippines. Address links to Google Maps. |
| 9.2 | September 10, 2026 | Contact page: "What Happens Next" section layout fixed — step numbers left-aligned to sit beside each step text instead of centred above them. |
| 9.3 | September 10, 2026 | GEO/SEO: Schema markup added site-wide (Organization, LocalBusiness, Person for Chenny and Jimbo, Service). Security headers added via next.config.js (X-Frame-Options, X-Content-Type-Options, Referrer-Policy, Permissions-Policy, Content-Security-Policy). Resources page: FAQ accordion section added before "Stay Connected" with 7 questions covering CFG's services, diagnostics, engagement process, location, and differentiation. FAQPage schema injected on the Resources page for AI and search engine citation. |
...
#### Intervention Programmes — 2×2 grid (v8.8)

A new section appears below the services carousel, above "How an engagement works." It presents the four named intervention programme categories in a 2-column responsive grid. Each card has a distinct coloured top border accent, an emoji icon, the programme name (with "For Good" in gold), an all-caps category label in the accent colour, and a description.

| Programme | Icon | Accent colour | Category label | Description |
|---|---|---|---|---|
| Tech For Good | ⚡ | Cyan / electric blue | Technology Enablement | Programs that amplify technology-enabled processes for companies and organizations — bridging the gap between digital potential and operational reality. |
| Build For Good | 🌱 | Green | Startups & Social Enterprise | Programs designed to support start-ups and social enterprises as they navigate their way to becoming a product or service built for social impact. |
| Lead For Good | 🧭 | Gold | Leadership Development | Programs designed to empower leaders in a technology-enabled environment — building the mindset, character, and capability to lead with clarity and courage. |
| Innovate For Good | 🚀 | Purple | Innovation & Transformation | Programs designed for innovation, learning, and transformation of seasoned organizations to be future-ready and agile in a highly disruptive business and governance landscape. |

**Section header:** "Four programmes. One purpose." with subheading: "Structured interventions designed to move organizations from where they are to where they need to be — for good."

**Responsive:** 2 columns on desktop (≥600px); single column on mobile.

**CSS class:** `.prog-grid` (2-column grid) and `.prog-card` (card surface with coloured top border per card).
...
|---|---|---|---|---|---|
| 1 | Live | When We Change How We Talk, We Change What We Build | `/resources/articles/4-levels-of-conversation` | Leadership | 8 min | `article-1-cover.png` — anchored top in card; full image on article page |
| 2 | Placeholder | The inner work that makes strategy stick | — | Leadership | 4 min | White CFG logo on dark purple gradient |
| 3 | Placeholder | Change for good — what continuous improvement really means | — | Growth | 6 min | White CFG logo on dark purple gradient |
...
| `cfg-logo-transparent.png` | Nav bar right side (white, PIL-processed); Articles 2 & 3 placeholder cards (white, 130px, `filter: brightness(0) invert(1)`) |
...
| `integrity.png` | About — How We Work carousel (sourced from `Project/Photos/About/Integrity.png`) |
| `courage-and-commitment.png` | About — How We Work carousel (sourced from `Project/Photos/About/Courage and Commitment.png`) |
| `article-1-cover.png` | Resources — Article 1 card thumbnail; Article 1 sub-page header (sourced from `Project/Photos/Resources/CFG Articles/Article - Listening is to Build Differently.png`) |

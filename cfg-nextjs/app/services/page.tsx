    ...
    <>
      ...
      <div className="section section-alt">
        ...
        <div className="step-row">
          <div className="step-item"><div className="step-num">1</div><div className="step-title">Discovery call</div><div className="step-desc">Free conversation &mdash; we learn about your business and goals</div></div>
          <div className="step-item"><div className="step-num">2</div><div className="step-title">Honest diagnosis</div><div className="step-desc">We assess where you are before proposing anything</div></div>
          <div className="step-item"><div className="step-num">3</div><div className="step-title">Co-create the plan</div><div className="step-desc">Solutions built with your team, not handed down</div></div>
          <div className="step-item"><div className="step-num">4</div><div className="step-title">Walk alongside</div><div className="step-desc">We stay with you through implementation &mdash; not just strategy</div></div>
        </div>
      </div>

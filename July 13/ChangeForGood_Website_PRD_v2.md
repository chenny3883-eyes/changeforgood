...
| Primary CTA | Start the conversation — opens the CFG Chat Assistant (see Section 4.8) |
| Secondary CTA | Explore our services — links directly to the Services tab |
| Hero image | Professional photo of Chenny — natural light, warm expression, clean background. NOT a stock photo. |
...
| Style | Grayscale logos on light background strip |
...
Four equal cards: Strategy Consulting, Business Development, Coaching for Infinite Growth, Innovation Sprint & Program Design.

Two secondary cards below: Marketing & Branding and Sales Consulting.
...
**Image requirement:** Candid photo of Chenny — genuine, warm, in her element. At a whiteboard, in a session, or at her desk. No formal headshots.

**The vision (to be written in Chenny's voice)**
...
| Headline | Five ways to work with us — all built around your real situation. |
...
**Primary services (lead with these)**

*Signature programme — featured card with gold border*
...
| CTA | Inquire about this programme — links directly to the Contact page |

*Core service cards (2x2 grid)*

| # | Service | Description |
|---|---|---|
| 01 | Strategy Consulting | Business vision and direction setting, competitive positioning, strategic planning, growth strategy, and organizational design. Grounded in data and the real external environment — not wishful thinking. |
| 02 | Business Development | Partnership development, new revenue stream identification, stakeholder engagement strategies, proposal and pitch development, and scaling frameworks for growing businesses. |
| 03 | Innovation Sprint & Program Design | Structured innovation sprints and multi-phase programs using globally proven frameworks — ExO, Business Model Canvas, Design Thinking, De Bono's Six Thinking Hats, Systems Thinking, and Theory U. We equip leaders and teams to challenge assumptions and bring new ideas to life. |
| 04 | Coaching for Infinite Growth | See signature programme above. |

*Innovation practice card — purple left border*

| Element | Content |
|---|---|
| Tag | Innovation practice |
| Name | Innovation Sprint & Program Design |
| Past work | Innovation summit design, business model redesign workshops, strategic ideation and prototyping, ExO strategy and MTP alignment |

**Secondary services (present but do not lead with)**

| Service | Description |
|---|---|
| Marketing & Branding | Brand identity development, messaging and positioning, marketing strategy, digital marketing, and content strategy. |
| Sales Consulting | Sales process design and optimization, team structure and coaching frameworks, pipeline development, customer acquisition and retention systems, and revenue performance reviews. |
...
To be added in the first iteration after launch. Chenny will collect quotes from select clients with written permission. The page should be designed to function fully without testimonials at launch, with clear space to add them.
...
Shown immediately after completing all 10 questions. Email was already captured on Screen 1.
...
The chatbot moves through the following steps in sequence:
...
**Challenge branches (ask-challenge chips)**
...
The recommendation message names the visitor ("Thank you, [Name]!"), highlights the suggested service in gold, confirms that Chenny personally reviews every message, and gives a 24-hour response commitment.
...
| Take the Diagnostic | Opens the Clarity-First Diagnostic sub-page (Resources tab) |
| That's all, thanks | Closes the chat panel |

**Email handling**
- Email is captured in the `ask-email` step if the visitor opts in
- Validated as a correctly formatted email address before the conversation advances
- If the visitor selects "Maybe later" at the soft ask, the email step is skipped and the conversation proceeds to the closing
- Captured email is logged to the browser console in the prototype. In Phase 2, this will be sent to Mailchimp via API
...
- Typing delay is proportional to message length: `Math.min(600 + text.length × 12, 2200)ms`
- Chat panel is always rendered in the DOM; toggled open/closed via CSS class
- FAB hides when the chat panel is open
- Built and live in prototype (Phase 1). Mailchimp email capture integration and CRM handoff to be wired in Phase 2.
...
**Approved theme: Dark purple background.** The website uses a deep royal purple as the dominant background color, with burnished gold as the primary accent. White and soft white are used for text. This was chosen over a light theme to best express the brand meaning — wisdom, depth, and the transformational weight of the work.

Reference file: `ChangeForGood_Website_Mockup_2_DarkPurple.html`
...
| Gold button | Same as primary button |
...
| Quote block | 3px left border in gold, light gold background, italic purple text |
...
| Image | Requirement |
|---|---|
| Chenny hero | Professional but approachable. Natural light. Genuine expression. No studio backdrop. |
| Chenny about | Candid — at a whiteboard, in a session, or at her desk. Warm and authentic. |
| Article covers | Editorial-style photography. Muted, professional tones. 3:2 aspect ratio. |
| Client logos | Grayscale on a light background strip. Uniform height. |
| Stock photography | AVOID generic stock photos of handshakes, boardrooms, or business teams. Use real photos wherever possible. |
...
| Chatbot | Scripted CFG Chat Assistant built and live in prototype (Phase 1). Mailchimp email capture and CRM handoff to be wired in Phase 2. Full AI-powered chatbot (if required) deferred to Phase 3 via Chenny's specialist contact. |
...
- Voice command / accessibility feature deferred — revisit once platform is confirmed
- Scripted CFG Chat Assistant is complete and live in the prototype; full AI-powered chatbot (Phase 3) to be handled by Chenny's specialist contact if required
- Testimonials to be added in first post-launch iteration as Chenny collects them
